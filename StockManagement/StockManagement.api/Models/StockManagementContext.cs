...
public partial class StockManagementContext : DbContext
{
    ...
    public virtual DbSet<GetAllProduct> GetAllProducts { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.FamilyId).HasName("PK__Family__41D82F6B5D6E1501");
        ...
        modelBuilder.Entity<GetAllProduct>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("GetAllProducts");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__B40CC6CD01850C7A");

            entity.ToTable("Product");

            entity.HasIndex(e => e.Ean13code, "UQ__Product__4425E36980EAA06E").IsUnique();

            entity.HasIndex(e => e.Ean13code, "UQ__Product__4425E369817C988F").IsUnique();

            entity.HasIndex(e => e.Ean13code, "UQ__Product__4425E369A041E8C3").IsUnique();

            entity.HasIndex(e => e.Ean13code, "UQ__Product__4425E369D2723238").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.ProductId, e.WarehouseId }).HasName("PK__Stock__366C4C32970DE1DE");
        ...
        {
            entity.HasKey(e => new { e.DocumentType, e.DocumentNumber, e.DocumentLineNumber }).HasName("PK__StocksDe__F871093C4154C0D0");
            ...
            entity.Property(e => e.TotalLineValue)
                .HasComputedColumnSql("([Quantity]*[UnitValue])", false)
        ...
        {
            entity.HasKey(e => new { e.DocumentType, e.DocumentNumber }).HasName("PK__StocksHe__3F0EB6CAB2AFE159");
        ...
        {
            entity.HasKey(e => e.WarehouseId).HasName("PK__Warehous__2608AFF916FD9F85");

            entity.ToTable("Warehouse");

            entity.Property(e => e.WarehouseId).HasMaxLength(10);
            entity.Property(e => e.InseFamilyrtUserId).HasMaxLength(30);
            entity.Property(e => e.InsertDateTime)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            entity.Property(e => e.LastModifiedDateTime).HasColumnType("datetime");
